...
export const aboutData = {
  ...
  paragraphThree:
    'In my free time, I immerse myself in learning new programming technologies and how to better myself as a programmer but also enjoy playing guitar, video games, reading, and spending time with my partner (since 2010).',
  resume:
